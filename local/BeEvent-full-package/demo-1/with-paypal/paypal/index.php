...
if($planName=='FrontSeat'):
	$price = $FrontSeat;
//	$totalAmt = $SeatsQuantity*$FrontSeat;
elseif($planName=='BackSeat'):
	$price = $BackSeat;
//	$totalAmt = $SeatsQuantity*$BackSeat;
elseif($planName=='MiddleSeat'):
	$price = $MiddleSeat;
//	$totalAmt = $SeatsQuantity*$MiddleSeat;
elseif($planName=='VIPSeate'):
	$price = $VIPSeate;
//	$totalAmt = $SeatsQuantity*$VIPSeate;
endif;
?>
