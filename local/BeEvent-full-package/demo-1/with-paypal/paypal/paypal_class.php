...
class paypal_class {
	...
	public function submit_paypal_post() {
		$paypal_url = (isset($_GET['sandbox']) == 1) ? SSL_SAND_URL : SSL_P_URL;
		echo "<html>";
		echo '<head><title>Processing Payment...</title>
		<link type="text/css" href="css/style.css"  rel="stylesheet" />
		</head>';
		echo "<body onLoad=\"document.forms['paypal_form'].submit();\">";
		echo '<div class="success_template">
...
<style>
body{ margin:0 auto;}
.pay_process{ display:none;}

h2{ margin-top:150px;font-size:40px; width:80%; text-transform:capitalize; padding: 50px 20px; line-height:50px;}
